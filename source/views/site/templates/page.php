...
/* @var $outstanding \app\models\LoanRelease[] */

$this->title = 'Loans as Comaker';
?><!DOCTYPE html>
...
<head lang="en">
    ...
    <title><?=ConfigUtil::getAppConfig('title', 'ProgStacks PHP');?></title>
...
<div class="wrapper">
    <div class="brand">
        <p><a href="#" class="logo"><?=ConfigUtil::getAppConfig('title', 'ProgStacks PHP');?></a></p>
    </div>
